...
if __name__ == '__main__':
    ...
    x = [p1, p2, p3, q1, q2, q3, c1, c2, c3, c4, c5, t1, t2, t3, t4, t5, t6, t7, t8, t9]
    p_list = [p1, p2, p3]
    q_list = [q1, q2, q3]
    p_q_list = [p1, p2, p3, q1, q2, q3]
    ...
    #  对乘法表每一行进行输入，这里还可以改进
    p = [0, 0, 0, 0, 1, p3, p2, p1, 1]
    q = [0, 0, 0, 0, 1, q3, q2, q1, 1]
    product_terms1 = [0, 0, 0, 0, 1, p3, p2, p1, 1]
    product_terms2 = [0, 0, 0, q1,	p3*q1,	p2*q1,	p1*q1,	q1, 0]
    product_terms3 = [0, 0, q2,	p3*q2,	p2*q2,	p1*q2,	q2, 0, 0]
    product_terms4 = [0, q3, p3*q3,	p2*q3,	p1*q3,	q3, 0, 0, 0]
    product_terms5 = [1, p3, p2, p1, 1, 0, 0, 0, 0]
    carries = [c5, c4, c3, c2, c1, 0, 0, 0, 0]

    # 建立乘法表数组
    A1 = np.vstack((p, q, product_terms1, product_terms2, product_terms3, product_terms4, product_terms5, carries, target_values))
    print(A1)

    # 对整个乘法表进行分块
    left0, cols0 = np.split(A1, [8], axis=1)  # 分出第一块
